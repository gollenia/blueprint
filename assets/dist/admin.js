...
const pageColorSettings = () => {
  ...
  if (!['post', 'page', 'event'].includes(postType)) return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null);
  const {
    meta,
    meta: {
      page_colors
