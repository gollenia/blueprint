...
class PageOptions {
    ...
    public static function get_page_colors($colors) {
        ...
        if(isset($color_meta['primary_color'])) {
            ...
            $colors[0]['brightness'] = isset($color_meta['primary_color_brightness']) ? $color_meta['primary_color_brightness'] : "dark";
        ...
        if(isset($color_meta['secondary_color'])) {
            ...
            $colors[1]['brightness'] = isset($color_meta['secondary_color_brightness']) ? $color_meta['secondary_color_brightness'] : "dark";
